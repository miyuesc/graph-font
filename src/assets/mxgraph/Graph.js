...
export class Graph extends mxGraph {
  ...
  _configConstituent() {
    ...
    mxGraphHandler.prototype.getInitialCellForEvent = function getInitialCellForEvent(
      ...args
    ) {
  ...
  _putVertexStyle() {
    ...
    const oldCreateSelectionShape =
      mxVertexHandler.prototype.createSelectionShape;
    mxVertexHandler.prototype.createSelectionShape = function createSelectionShape(
      ...args
    ) {
  ...
  _configCustomEvent() {
    ...
    mxGraphHandler.prototype.createPreviewShape = function createPreviewShape(
      ...args
    ) {
